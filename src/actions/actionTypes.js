...
export const PALETTE_SELECTED = 'palette/paletteSelected';

export const NUM_GUESSES_CHANGED = 'settings/numGuessesChanged';
export const CODE_LENGTH_CHANGED = 'settings/codeLengthChanged';
export const NUM_COLORS_CHANGED = 'settings/numColorsChanged';